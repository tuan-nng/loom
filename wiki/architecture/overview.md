...
- **Terminal tier** — BubbleTea v2 TUI with board, card-detail, forms, search, switch pickers, and help views (board shell + session markers shipped T16–T17; forms landed T18; card detail landed T19; search/switch/help landed T20). Canonical keybindings in ADR-001 §3.5 (board render model from [kancli](../../docs/ADR-001-loom-architecture.md)).
